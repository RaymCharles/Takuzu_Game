...
#define DEFAULT_SIZE_COLUMN 6
#define DEFAULT_SIZE_LINE 6
 ...
 *row-major storage \pre \p squares must be an initialized array of default size
 *squared. \return the created game
 **/
 ...
 *game. \param g the game \param i row index \param j column index \param s the
 *square value \pre \p g must be a valid pointer toward a game structure. \pre
 *\p i < game height \pre \p j < game width \pre \p s must be a valid square
 *value.
 **/
 ...
 * \pre \p j < game width
 * \pre \p dist <= 2
 * \return the value of the targeted square, or -1 if this square is out of the
 *grid
 **/
 ...
 * \pre \p j < game width
 * \pre \p dist <= 2
 * \return the number of the targeted square (0 or 1),
 * or -1 if this square is empty or out of the grid
 **/
...
// ---------------------------------------------------------------------------------------------
/**
 * \brief Tests if a given square is empty.
 * \param g the game
 * \param i row index
 * \param j column index
 * \pre \p g must be a valid pointer toward a game structure.
...
// ---------------------------------------------------------------------------------------------
/**
 * \brief Tests if a given square is immutable.
 * \param g the game
 * \param i row index
 * \param j column index
 * \pre \p g must be a valid pointer toward a game structure.
 * \pre \p i < game height
 * \pre \p j < game width
 * \return true if the square is immutable, false otherwise
 **/
...
// ---------------------------------------------------------------------------------------------
/**
 * \brief Tests if a given square has an error.
 * \param g the game
 * \param i row index
 * \param j column index
 * \pre \p g must be a valid pointer toward a game structure.
